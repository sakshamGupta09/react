...
```ts
import { IFilters, INITIAL_FILTERS } from "./filters/store";
import { INITIAL_TODOS, ITodo } from "./todos/store";
...
import { IAppState, INITIAL_APP_STATE } from "./store";
import { TodoAction } from "./todos/actions";
import todoReducer from "./todos/reducer";

export function reducer(
  state = INITIAL_APP_STATE,
  action: FilterAction | TodoAction
): IAppState {
  return {
...
- The Redux core library includes a utility called combineReducers, which does this same boilerplate step for us.
