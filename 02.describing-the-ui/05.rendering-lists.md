...
- If our array items can move due to sorting, reverse, insertion, deletion etc React can still pinpoint to the component rather than tearing down and recreating the entire tree.
