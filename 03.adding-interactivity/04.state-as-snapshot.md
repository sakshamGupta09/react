...
- State behaves more like a snapshot. When React renders a component, during that rendering, it reads the value of state variable from `useState` function and that state always remain same like a snapsho for that render.
